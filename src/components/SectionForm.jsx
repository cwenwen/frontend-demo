...
function SectionForm() {
  return (
    <Element name="form">
      <section
        id="form"
        className="my-5 flex flex-col items-center px-3.5 lg:mb-0 lg:flex-row lg:border-t lg:border-dashed lg:px-[30px]"
      >
        <div className="flex flex-col gap-5 py-2.5 lg:basis-1/2">
          <StorefrontSvg className="w-[87px] lg:w-[112px]" />
          <h2 className="text-[55px]/[120%] tracking-[-2.2px] lg:text-[100px] lg:leading-none lg:tracking-[-5px]">
            Want to be on our shelves?
          </h2>
          <p className="font-ppNeueMontreal400 text-[15px]/[160%] tracking-[0.3px] lg:text-[19px]/[170%] lg:tracking-[0.19px]">
          ...
          <div className="w-full border-t border-dashed border-black lg:border-none" />
        </div>
        <form className="font-ppNeueMontreal400 flex flex-col items-start gap-4 pt-2.5 text-[15px]/[160%] tracking-[0.3px] lg:ml-20 lg:basis-1/2 lg:border-l lg:border-dashed lg:pt-[130px] lg:pr-10 lg:pb-[70px] lg:pl-20">
